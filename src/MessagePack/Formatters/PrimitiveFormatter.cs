...
namespace MessagePack.Formatters
{
    ...
    public sealed class SingleFormatter : IMessagePackFormatter<Single>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Single value, IFormatterResolver formatterResolver, SerializationContext context)
        {
            return MessagePackBinary.WriteSingle(ref bytes, offset, value);
        }

        public Single Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize, DeserializationContext context)
        {
    ...
    public sealed class DoubleFormatter : IMessagePackFormatter<Double>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Double value, IFormatterResolver formatterResolver, SerializationContext context)
        {
            return MessagePackBinary.WriteDouble(ref bytes, offset, value);
        }

        public Double Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize, DeserializationContext context)
        {
    ...
    public sealed class BooleanFormatter : IMessagePackFormatter<Boolean>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Boolean value, IFormatterResolver formatterResolver, SerializationContext context)
        {
            return MessagePackBinary.WriteBoolean(ref bytes, offset, value);
        }

        public Boolean Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize, DeserializationContext context)
        {
    ...
    public sealed class CharFormatter : IMessagePackFormatter<Char>
    {
        ...
        public int Serialize(ref byte[] bytes, int offset, Char value, IFormatterResolver formatterResolver, SerializationContext context)
        {
            return MessagePackBinary.WriteChar(ref bytes, offset, value);
        }

        public Char Deserialize(byte[] bytes, int offset, IFormatterResolver formatterResolver, out int readSize, DeserializationContext context)
        {
