...
namespace BenchmarkJsonNet
{
    public class Benchmark
    {
        ...
        {
            var jsonString = JsonConvert.SerializeObject(_person);
        }

        public void DeserializeModel()
        {
            var person = JsonConvert.DeserializeObject<Person>(_serialized);
        }
        ...
        public void CreateModel(int petsCount)
        {
            ...
            _serialized = JsonConvert.SerializeObject(_person);
        }
